	...
	\begin{slide}{Data visualization}
		\begin{center}
			\begin{figure}
				\setlength{\abovecaptionskip}{0.5cm}
				\centering
				\includegraphics[scale=0.5]{C:/Users/77967/Desktop/Flip00/1.eps}\\	
	...
	\begin{slide}{Data visualization}
		\begin{center}
			\begin{figure}
				\setlength{\abovecaptionskip}{0.5cm}
				\centering
				\includegraphics[scale=0.5]{C:/Users/77967/Desktop/Flip00/2a.eps}\\	
				\caption{Correlations between Pclass and survived}
				\label{fig:Correlations between individual features and survival}
			\end{figure}
		\end{center}
	...
	\begin{slide}{Data visualization}
		\begin{center}
			\begin{figure}
				\setlength{\abovecaptionskip}{0.5cm}
				\centering
				\includegraphics[scale=0.5]{C:/Users/77967/Desktop/Flip00/3.eps}\\	
				\caption{Correlations between Pclass and survived}
				\label{fig:Correlations between individual features and survival}
			\end{figure}
		\end{center}
...
\begin{slide}{Data visualization}
	\begin{center}
		...
		\twotonebox{\rotatebox{90}{Defn}}{\parbox{.86\textwidth}
			{After the above data analysis of 11 features (excluding the Survived label), the conclusions are as follows:
				\begin{itemize}
					\item PassengerId for ID, Ticket characteristics are hard to find, Cabin missing too much, so need to be deleted;
					\item Name features can be extracted part of gender, unmarried information, married status, etc.;
					\item Sex, Pclass, Age, Embarked, Fare is very important, there is a certain relationship between and characteristics;
					\item SibSp, Parch characteristics about the distribution of survival, and both can add response personnel of a family. You can try adding;
					\item Age, Embarked, Fare, there is a missing data need to be filled.
					\item Sex, Emabrked need into classification of numeric characteristic;
					\item the Age before, Fare according to the analysis of reasonable section;
				\end{itemize}
		}}
	\end{center}
